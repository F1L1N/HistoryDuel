...
import 'package:history_duel/style/theme.dart' as Theme;
...
class LoginScreenState extends State<LoginScreen>
  ...
  String authUrl = "http://hisduel.000webhostapp.com/authentication.php";
  int tries = 0;
  int maxTries = 5;
  ...
  Future<Tokens> runRegPost({Map body}) async {
  ...
  void signUp() async {
    RegistrationPost newPost = new RegistrationPost(
        login: signupNameController.text,
        email: signupEmailController.text,
        password: signupPasswordController.text);
    Tokens tokens = await runRegPost(body: newPost.toMap());
